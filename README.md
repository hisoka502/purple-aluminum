...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fd439f264f07b001564dbfa
...
To start editing your site, you can use the Sanity interface at https://purple-aluminum-439f2.sanity.studio/.
...
Generated at `2020-12-12T03:34:23.587Z` by Stackbit version `0.3.39`.